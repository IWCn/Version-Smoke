...
if($page=='')
{
	$target=SERVER_ROOT . '/protected/views/frontend/home.php';
}
else
{
//compute the path to the file
$target = SERVER_ROOT . '/protected/views/frontend/' . $page . '.php';
}


$header = SERVER_ROOT . '/protected/config/layout/header.php';
$footer = SERVER_ROOT . '/protected/config/layout/footer.php';
$error = SERVER_ROOT . '/protected/config/layout/404.php';
